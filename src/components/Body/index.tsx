...
export default function Body() {
    return (
        <main className='hidden md:block px-20 mx-20 my-20 overflow-hidden'>
            ...
            <div className='flex my-8'>
                <Image
                    ...
                    alt="Image of the gallery painting from behind a bench."
                    className='w-3/5 h-[720px] pr-4'
                    width={635}
                    height={720}
                />
                ...
                <div className='flex flex-col w-2/5 '>
                    <Image
                        ...
                        alt="Image of the gallery hallway with painting hanging on the wall."
                        className='w-full h-[313px]'
                        width={445}
                        height={313}
                    />
                    <div className='w-full h-[375px] bg-[#141414] mt-8 overflow-hidden'>
                        <div className='w-[295px] h-[198px] inset-x-[40px] inset-y-[2110px] py-12 pl-8'>
                            <h1 className={`${bigShouldersDisplay.className} uppercase text-6xl font-bold text-[#FFFFFF] leading-[50px} pb-8`}>
                                Come & Be inspired
                            </h1>
